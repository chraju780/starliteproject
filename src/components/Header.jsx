...
const Header = () => {
    return (
        ...
        <div id="home" className="header-hero bg_cover" style={{backgroundImage: "url(https://preview.uideck.com/items/start/assets/images/header-bg.jpg)"}}>
            <div className="container">
            ...
            <div className="header-shape">
                <img src="https://preview.uideck.com/items/start/assets/images/header-shape.svg" alt="shape"/>
            </div>
        </div> 
    </header>
